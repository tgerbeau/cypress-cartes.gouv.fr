...
describe('Accessibilité des pages secondaires (axe-core)', { tags: '@a11y' }, () => {
  ...
  auditPage('Fiche BD TOPO', '/rechercher-une-donnee/dataset/IGNF_BD-TOPO')
  ...
  auditPage('Éditeur cartographique', '/editeur')
  auditPage('Explorer les cartes', '/explorer-les-cartes/')
  auditPage('Nous écrire (contact)', '/aide/fr/nous-ecrire/')
  auditPage('Connexion', '/login')
})
